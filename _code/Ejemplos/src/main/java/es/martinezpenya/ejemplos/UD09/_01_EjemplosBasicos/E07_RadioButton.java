 ...
 */
package es.martinezpenya.ejemplos.UD09._01_EjemplosBasicos;
        ...
        grupo.selectedToggleProperty().addListener(
                (ObservableValue<? extends Toggle> ov, Toggle old_toggle, Toggle new_toggle) -> {
                    if (grupo.getSelectedToggle() != null) {
                        image.setImage(new Image(E07_RadioButton.class.getResourceAsStream(grupo.getSelectedToggle().getUserData().toString() + ".png")));
                    }
                });
