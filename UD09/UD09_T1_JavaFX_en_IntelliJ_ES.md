---
title: Taller UD09_1: JavaFX en IntelliJ
language: ES
...
## Añadir la libreria (JAR) de JavaFX a un proyecto IntelliJ
...
Reproduce los pasos de esta guia en tu ordenador, crea un proyecto con la libreria JAR de JavaFX añadida manualmente a un proyecto de IntelliJ. En lugar del texto "Hola Mundo" debe aparecer tu nombre, apellido y la fecha.

Genera un fichero pdf con los pasos seguidos para conseguirlo con capturas y explicaciones con tus propias palabras.

Genera un zip con el proyecto de IntelliJ (o la carpeta src del IDE que uses) y añade el pdf de la memoria. Envíalo todo junto (como archivo zip) a la tarea de Aules.
