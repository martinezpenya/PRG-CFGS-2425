...
INSERT INTO posts (usuario_id, titulo, contenido, fecha_publicacion) VALUES
    (1, 'Título del Post 1', 'Contenido del Post 1', '2024-04-01'),
    (2, 'Título del Post 2', 'Contenido del Post 2', '2024-04-02'),
    (3, 'Título del Post 3', 'Contenido del Post 3', '2024-04-03'),
    (4, 'Título del Post 4', 'Contenido del Post 4', '2024-04-04'),
    (5, 'Título del Post 5', 'Contenido del Post 5', '2024-04-05'),
    (6, 'Título del Post 6', 'Contenido del Post 6', '2024-04-06'),
    (7, 'Título del Post 7', 'Contenido del Post 7', '2024-04-07'),
    (8, 'Título del Post 8', 'Contenido del Post 8', '2024-04-08'),
    (9, 'Título del Post 9', 'Contenido del Post 9', '2024-04-09'),
    (10, 'Título del Post 10', 'Contenido del Post 10', '2024-04-10'),
    (11, 'Título del Post 11', 'Contenido del Post 11', '2024-04-11'),
    (12, 'Título del Post 12', 'Contenido del Post 12', '2024-04-12'),
    (13, 'Título del Post 13', 'Contenido del Post 13', '2024-04-13'),
    (14, 'Título del Post 14', 'Contenido del Post 14', '2024-04-14'),
    (15, 'Título del Post 15', 'Contenido del Post 15', '2024-04-15');

INSERT INTO comentarios (usuario_id, post_id, contenido, fecha_comentario) VALUES
    (1, 1, 'Comentario 1 al Post 1', '2024-04-01'),
    (2, 2, 'Comentario 1 al Post 2', '2024-04-02'),
    (3, 3, 'Comentario 1 al Post 3', '2024-04-03'),
    (4, 4, 'Comentario 1 al Post 4', '2024-04-04'),
    (5, 5, 'Comentario 1 al Post 5', '2024-04-05'),
    (6, 6, 'Comentario 1 al Post 6', '2024-04-06'),
    (7, 7, 'Comentario 1 al Post 7', '2024-04-07'),
    (8, 8, 'Comentario 1 al Post 8', '2024-04-08'),
    (9, 9, 'Comentario 1 al Post 9', '2024-04-09'),
    (10, 10, 'Comentario 1 al Post 10', '2024-04-10'),
    (11, 11, 'Comentario 1 al Post 11', '2024-04-11'),
    (12, 12, 'Comentario 1 al Post 12', '2024-04-12'),
    (13, 13, 'Comentario 1 al Post 13', '2024-04-13'),
    (14, 14, 'Comentario 1 al Post 14', '2024-04-14'),
    (15, 15, 'Comentario 1 al Post 15', '2024-04-15');
